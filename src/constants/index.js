  ...
  children: [
    {
      ...
      position: "top-5 left-10",
      description: [
        "Seahawk Adventures - Adventure Tourism Website",
        "Tech Stack: Next.js, React, TypeScript, Tailwind CSS",
        "• Developed a responsive, modern website for an adventure tourism company with a strong focus on user experience and performance.",
        "• Built reusable UI components, optimised page loading, and ensured seamless responsiveness across desktop and mobile devices.",
        "• Collaborated closely with stakeholders to deliver an engaging interface showcasing travel experiences and booking information.",
      ],
    },
    {
      id: 2,
      name: "seahawkadventures.com",
      icon: "/images/safari.png",
      kind: "file",
      fileType: "url",
      href: "https://www.seahawkadventures.com/",
      position: "top-10 right-20",
    },
    {
      id: 3,
